...
default['security_policy']['user_rights']['SeTrustedCredManAccessPrivilege'] = []

# 2.2.2 (L1) Ensure 'Access this computer from the network' is set to 'Administrators, Remote Desktop Users'
default['security_policy']['user_rights']['SeNetworkLogonRight'] = ['*S-1-5-32-544', '*S-1-5-32-555']
...
default['security_policy']['user_rights']['SeRemoteInteractiveLogonRight'] = ['*S-1-5-32-544', '*S-1-5-32-555']

# 2.2.7 (L1) Ensure 'Back up files and directories' is set to 'Administrators'
default['security_policy']['user_rights']['SeBackupPrivilege'] = ['*S-1-5-32-544']
...
default['security_policy']['user_rights']['SeCreateSymbolicLinkPrivilege'] = ['*S-1-5-32-544']

# 2.2.15 (L1) Ensure 'Debug programs' is set to 'Administrators'
default['security_policy']['user_rights']['SeDebugPrivilege'] = ['*S-1-5-32-544']

# 2.2.16 (L1) Ensure 'Deny access to this computer from the network' to include 'Guests, Local account'
default['security_policy']['user_rights']['SeDenyNetworkLogonRight'] = ['*S-1-5-32-546', '*S-1-5-113']

# 2.2.17 (L1) Ensure 'Deny log on as a batch job' to include 'Guests'
default['security_policy']['user_rights']['SeDenyBatchLogonRight'] = ['*S-1-5-32-546']

# 2.2.18 (L1) Ensure 'Deny log on as a service' to include 'Guests'
default['security_policy']['user_rights']['SeDenyServiceLogonRight'] = ['*S-1-5-32-546']

# 2.2.19 (L1) Ensure 'Deny log on locally' to include 'Guests'
default['security_policy']['user_rights']['SeDenyInteractiveLogonRight'] = ['*S-1-5-32-546']

# 2.2.20 (L1) Ensure 'Deny log on through Remote Desktop Services' to include 'Guests, Local account'
default['security_policy']['user_rights']['SeDenyRemoteInteractiveLogonRight'] = ['*S-1-5-32-546', '*S-1-5-113']

# 2.2.21 (L1) Ensure 'Enable computer and user accounts to be trusted for delegation' is set to 'No One'
default['security_policy']['user_rights']['SeEnableDelegationPrivilege'] = []

# 2.2.22 (L1) Ensure 'Force shutdown from a remote system' is set to 'Administrators'
default['security_policy']['user_rights']['SeRemoteShutdownPrivilege'] = ['*S-1-5-32-544']
...
default['security_policy']['user_rights']['SeLoadDriverPrivilege'] = ['*S-1-5-32-544']

# 2.2.27 (L1) Ensure 'Lock pages in memory' is set to 'No One'
default['security_policy']['user_rights']['SeLockMemoryPrivilege'] = []

# 2.2.28 (L2) Ensure 'Log on as a batch job' is set to 'Administrators'
default['security_policy']['user_rights']['SeBatchLogonRight'] = ['*S-1-5-32-544']

# 2.2.29 (L2) Ensure 'Log on as a service' is set to 'No One'
default['security_policy']['user_rights']['SeServiceLogonRight'] = []

# 2.2.30 (L1) Ensure 'Manage auditing and security log' is set to 'Administrators'
default['security_policy']['user_rights']['SeSecurityPrivilege'] = ['*S-1-5-32-544']

# 2.2.31 (L1) Ensure 'Modify an object label' is set to 'No One'
default['security_policy']['user_rights']['SeRelabelPrivilege'] = []

# 2.2.32 (L1) Ensure 'Modify firmware environment values' is set to 'Administrators'
default['security_policy']['user_rights']['SeSystemEnvironmentPrivilege'] = ['*S-1-5-32-544']

# 2.2.33 (L1) Ensure 'Perform volume maintenance tasks' is set to 'Administrators'
default['security_policy']['user_rights']['SeManageVolumePrivilege'] = ['*S-1-5-32-544']

# 2.2.34 (L1) Ensure 'Profile single process' is set to 'Administrators'
default['security_policy']['user_rights']['SeProfileSingleProcessPrivilege'] = ['*S-1-5-32-544']

# 2.2.35 (L1) Ensure 'Profile system performance' is set to 'Administrators, NT SERVICE\WdiServiceHost'
default['security_policy']['user_rights']['SeSystemProfilePrivilege'] = ['*S-1-5-32-544', '*S-1-5-80-3139157870-2983391045-3678747466-658725712-1809340420']

# 2.2.36 (L1) Ensure 'Replace a process level token' is set to 'LOCAL SERVICE, NETWORK SERVICE'
default['security_policy']['user_rights']['SeAssignPrimaryTokenPrivilege'] = ['*S-1-5-19', '*S-1-5-20']

# 2.2.37 (L1) Ensure 'Restore files and directories' is set to 'Administrators'
default['security_policy']['user_rights']['SeRestorePrivilege'] = ['*S-1-5-32-544']

# 2.2.38 (L1) Ensure 'Shut down the system' is set to 'Administrators, Users'
default['security_policy']['user_rights']['SeShutdownPrivilege'] = ['*S-1-5-32-544', '*S-1-5-32-545']

# 2.2.39 (L1) Ensure 'Take ownership of files or other objects' is set to 'Administrators'
default['security_policy']['user_rights']['SeTakeOwnershipPrivilege'] = ['*S-1-5-32-544']
