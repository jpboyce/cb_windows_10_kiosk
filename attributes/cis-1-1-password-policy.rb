...
default['security_policy']['password_policy']['MinimumPasswordAge'] = 1

# 1.1.4 (L1) Ensure 'Minimum password length' is set to '14 or more character(s)'
default['security_policy']['password_policy']['MinimumPasswordLength'] = 15

# 1.1.5 (L1) Ensure 'Password must meet complexity requirements' is set to 'Enabled'
default['security_policy']['password_policy']['PasswordComplexity'] = 1

# 1.1.6 (L1) Ensure 'Store passwords using reversible encryption' is set to 'Disabled'
default['security_policy']['password_policy']['ClearTextPassword'] = 0
