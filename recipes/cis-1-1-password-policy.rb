...
security_policy 'Maximum password age' do
  policy_template "#{node['cb_windows_10_kiosk']['secedit_template']['location']}\\Maximum_password_age.inf"
  database "#{node['cb_windows_10_kiosk']['secedit_database']['location']}\\#{node['cb_windows_10_kiosk']['secedit_database']['name']}"
  action :configure
end
...
security_policy 'Minimum password age' do
  policy_template "#{node['cb_windows_10_kiosk']['secedit_template']['location']}\\Minimum_password_age.inf"
  database "#{node['cb_windows_10_kiosk']['secedit_database']['location']}\\#{node['cb_windows_10_kiosk']['secedit_database']['name']}"
  action :configure
end
...
security_policy 'Minimum password length' do
  policy_template "#{node['cb_windows_10_kiosk']['secedit_template']['location']}\\Minimum_password_length.inf"
  database "#{node['cb_windows_10_kiosk']['secedit_database']['location']}\\#{node['cb_windows_10_kiosk']['secedit_database']['name']}"
  action :configure
end
...
security_policy 'Password must meet complexity requirements' do
  policy_template "#{node['cb_windows_10_kiosk']['secedit_template']['location']}\\Password_must_meet_complexity_requirements.inf"
  database "#{node['cb_windows_10_kiosk']['secedit_database']['location']}\\#{node['cb_windows_10_kiosk']['secedit_database']['name']}"
  action :configure
end
...
security_policy 'Store passwords using reversible encryption' do
  policy_template "#{node['cb_windows_10_kiosk']['secedit_template']['location']}\\Store_passwords_using_reversible_encryptiony.inf"
  database "#{node['cb_windows_10_kiosk']['secedit_database']['location']}\\#{node['cb_windows_10_kiosk']['secedit_database']['name']}"
  action :configure
end
